...
namespace product-list.Model
{
    ...
    /// </summary>
    [DataContract(Name = "productlistProductListAssociation")]
    public partial class ProductlistProductListAssociation : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductlistProductListAssociation" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="listId">listId.</param>
        /// <param name="position">position.</param>
        /// <param name="productGrn">productGrn.</param>
        public ProductlistProductListAssociation(string id = default(string), string listId = default(string), int position = default(int), string productGrn = default(string))
        {
            this.Id = id;
            this.ListId = listId;
